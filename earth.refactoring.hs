...
south_pole = Coordinate (Latitude (-pi)) prime_meridian

antipode :: Coordinate -> Coordinate
antipode (Coordinate φ λ) = Coordinate (-φ) (if λ > 0 then λ - pi else λ + pi)
...
-- [1] - https://en.wikipedia.org/w/index.php?title=Flattening&oldid=748220388#Definitions_of_flattening
-- [2] - https://en.wikipedia.org/w/index.php?title=Eccentricity_(mathematics)&oldid=745896620#Ellipses
-- [3] - https://en.wikipedia.org/w/index.php?title=Spheroid&oldid=750391316#Properties
-- [4] - https://en.wikipedia.org/w/index.php?title=Earth_radius&oldid=750893232#Mean_radius
-- [5] - https://en.wikipedia.org/w/index.php?title=Earth_radius&oldid=750893232#Authalic_radius

main = putStrLn $ show $ antipode north_pole == south_pole
